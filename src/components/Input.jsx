...
const Input = ({ startIcon ,endIcon, value, inpType, placeHolder }) => {
  return (
    <div className="group">
        ...
        <input type={inpType} value={value} placeholder={placeHolder} className="w-full h-ful outline-none bg-transparent focus:text-blue-600 text-slate-600 font-medium" />
        {endIcon && endIcon}
    </button>
    </div>
  )
